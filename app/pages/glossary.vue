...
<template>
  ...
  <UDashboardPanel>
    <template #header>
      <!-- Mobile-only navbar hosts the sidebar toggle; desktop shows the
           sidebar itself. -->
      ...
      <div class="mx-auto w-full max-w-3xl text-left">
        <header class="mb-8">
          ...
          <p class="text-gray-600 dark:text-gray-400">
            Plain-language explanations of the acronyms and terms used across
            this dashboard. Search below, or link straight to a term with
